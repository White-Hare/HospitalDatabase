...
final public class JDBCPatientRepository extends JDBCConnection implements IRepository<Patient> {
    ...
    public ArrayList<PatientDetail> getAllPatientDetailByTcNo(String tcNo) throws SQLException {
        try {
            statement = connection.createStatement();
            resultSet = statement.executeQuery("select patients.firstName,patients.lastName," +
            ...
            while (resultSet.next()) {
                patients.add(new PatientDetail(resultSet.getString("tcNo"), resultSet.getString("firstName"),
                        resultSet.getString("lastName"), resultSet.getString("doctorname"),
                        resultSet.getString("doctorlastname"), resultSet.getString("date"),
                        resultSet.getString("name")));
            }
